                ...
                <div>
                    <div class="flex justify-between">
                        <div v-if="user" class="flex flex-col gap-5 ps-6 py-6">
                            <h1 class="text-3xl tracking-wide uppercase">{{$article->title}}</h1>
                            <h3 class="text-lg tracking-wide uppercase">{{$article->subtitle}}</h3>
                        </div>
                        <div class="p-6">
                        ...
                        <div class="mx-auto  grid grid-cols-3 gap-6">
                            ...
                            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                                <div class="p-6 flex justify-between text-gray-900 dark:text-gray-100">
                                    {{ __("Comments Count") }}
                                    <h3 class="text-3xl">{{count($article->comments)}}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
