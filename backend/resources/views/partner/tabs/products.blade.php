<div x-data="productHandler()" x-init="fetchFilteredProducts()"
         class="space-y-6">
            ...
            <div
                   ...
                   <template x-if="product.image">
                    ...
                    <div class="absolute top-3 left-3">
                        <span class="px-3 py-1 rounded-full text-xs font-semibold "
                         x-text="product.is_available ? 'Disponibile' : 'Non disponibile'"
                ...
                <div class="p-6">
                    <div class="flex justify-between items-start mb-3">
                        ...
                        <span class="text-purple-400 font-bold text-lg ml-2" x-text="product.points_price + 'pts'"></span>
                    </div>

                    <p class="text-gray-400 text-sm mb-4 line-clamp-2" x-text="product.description"></p>

                    <div class="flex items-center justify-between mb-4">
                        <span class="text-sm text-gray-500 bg-gray-700/50 px-2 py-1 rounded-full capitalize" x-text="product.category">
                    ...
                    <div class="flex gap-2">
                        ...
                        <button @click="toggleAvailability(product.id)" type="button"
                            class="flex-1 px-3 py-1 rounded text-white text-sm transition-colors "
                            :class="product.is_available 
