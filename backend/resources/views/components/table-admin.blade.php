        ...
        hover:bg-[#FFF6F4]/90 dark:hover:bg-[#25262D]/80 hover:shadow-sm"
            ...
            @foreach ($columns as $key => $label)
                <div class="px-6 py-5 text-[15px] text-foreground lg:truncate" role="cell">
                    <span
                        class="block mb-1 text-[11px] font-semibold tracking-wide text-muted lg:hidden">
                        {{ $label }}
                    </span>
            ...
            @if ($actions)
                <div class="flex items-center justify-center px-6 py-5 text-sm text-center lg:py-4 lg:px-6"
                    role="cell">
                    <span
                        class="block mb-1 text-[11px] font-semibold tracking-wide uppercase text-muted lg:hidden">
                        Azioni
                    </span>
                    {{ $actions($row) }}
                </div>
