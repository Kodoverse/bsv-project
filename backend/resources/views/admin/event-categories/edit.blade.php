    <x-admin-layout title="Modifca Categoria Evento {{ $eventCategory->name }}" :breadcrumbs="[
        ...
        <div class="flex flex-col items-center w-full py-10 overflow-hidden">
            <div class="w-full max-w-5xl md:px-8">
                <x-form-admin :action="route('admin.event-categories.update', $eventCategory->id)" method="PUT" submit-label="Modifica Categoria"
                    enctype="multipart/form-data">
                    <x-form-section>
                        <x-input-admin id="name" label="Nome Categoria" type="text" name="name"
