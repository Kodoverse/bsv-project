                ...
                <div>
                    <div class="flex justify-between">
                        <div v-if="user" class="flex flex-col gap-5 ps-6 py-6">
                            <h1 class="text-3xl tracking-wide uppercase">Create an Article</h1>
                        </div>
                    </div>
                    ...
                    <div class="px-6 w-full">
                        ...
                        <div class="flex justify-start">
                            ...
                            <form action="{{ route('articles.store') }}" enctype="multipart/form-data" method="POST" class="max-w-xl w-full">
                                @csrf
                              <div class="mb-5">
                              ...
                              <div class="mb-5">
                                  ...
                                  @enderror" name="article"></textarea>
                                    @error('article')
                                    <div>
                                        {{ $message }}
                                    </div>
