                ...
                <div>
                    <div class="flex justify-between">
                        <div v-if="user" class="flex flex-col gap-5 py-6 ps-6">
                            <h1 class="text-3xl tracking-wide uppercase">Create a product</h1>
                        </div>
                    </div>
                    ...
                    <div class="w-full px-6">
                        ...
                        <div class="flex justify-start">
                            ...
                            <form action="{{ route('products.store') }}" enctype="multipart/form-data" method="POST" class="w-full max-w-xl">
                                @csrf
                              <div class="mb-5">
