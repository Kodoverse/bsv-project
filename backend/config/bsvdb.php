...
return [
    ...
    'sidebar_items' => [
        ...
        [
            ...
            'route' => 'admin.event-categories.create',
            'icon' => 0,
            'parent_id' => 7,
            'roles' => ['admin'],
            'is_enabled' => 1,
        ...
        [
            'id' => 11,
            'label' => 'Aggiungi una Sotto Categoria',
            'route' => 'admin.subcategories-event.create',
            'icon' => 0,
            'parent_id' => 10,
            'roles' => ['admin'],
            'is_enabled' => 1,
        ...
        [
            'id' => 12,
            'label' => 'Tutte le Sotto Categorie',
            'route' => 'admin.event-categories.index',
            'icon' => 0,
            'parent_id' => 10,
            'roles' => ['admin'],
